...
public class BiodataStationRowMapper implements RowMapper<BiodataStation> {
	...
	public BiodataStation mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		station.setOrganization(rs.getString(BiodataOrganizationRowMapper.ORGANIZATION_COLUMN_NAME));
		station.setOrganizationName(rs.getString(BiodataOrganizationRowMapper.ORGANIZATION_NAME_COLUMN_NAME));
